...
\usepackage[nosort]{cite} %% this works....if you cite a lot of references, then in the thesis, all of them will show up, like [1,2,3,4,5,6,7,8], but if you add this package then it dispalys alternatively as [1-8]. Looks nicer
